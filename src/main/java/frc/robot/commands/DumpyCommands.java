...
public class DumpyCommands {
    ...
    public static Command dumpyToAnglePID(DumpSub dumpySub, double angle) {
    ...
    public static Command dumpyToggle(DumpSub dumpySub) {
