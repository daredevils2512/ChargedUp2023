...
public class ElevatorSub extends SubsystemBase {
  ...
  public ElevatorSub() {
    ...
    m_doubleSolenoid = new DoubleSolenoid(PneumaticsModuleType.CTREPCM, ElevatorConstants.FORWARD_CHANNEL,
        ElevatorConstants.REVERSE_CHANNEL);
  ...
  // once upon a time Kobi was a big dumb baby man, who smells like farts. then we
  // desicrate him
  ...
  public double getLength() {
    return m_frontMotor.getSelectedSensorPosition() / ElevatorConstants.TICKS_PER_REVOLUTION
        * ElevatorConstants.GEAR_RATIO * ElevatorConstants.DISTANCE_PER_REVOLUTION;
  }
