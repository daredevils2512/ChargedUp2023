...
public class ElevatorSub extends SubsystemBase {
    ...
    public double getLength() {
        return leftMotor.getSelectedSensorPosition() / ElevatorConstants.TICKS_PER_REVOLUTION * ElevatorConstants.GEAR_RATIO * ElevatorConstants.DISTANCE_PER_REVOLUTION;
    }
    ...
    public void periodic() {
        ...
        rawEncoderUnits.setDouble(leftMotor.getSelectedSensorPosition());
