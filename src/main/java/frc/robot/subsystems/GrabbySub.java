...
public class GrabbySub  extends SubsystemBase {
  ...
  public GrabbySub() {
    grabber = new DoubleSolenoid(GrabbyConstants.PNEUMATICS_MODULE_TYPE, GrabbyConstants.INTAKE_SHIFTER_FORWARD_ID1, GrabbyConstants.INTAKE_SHIFTER_BACKWARD_ID1);
